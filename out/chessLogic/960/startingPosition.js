...
function frcGen(idPositionNumber) {
    ...
    function makeFen(board) {
        let str = "";
        for (let i = 0; i <= 7; i++)
            str += num2Piece(board[i]).toLowerCase();
        str += "/pppppppp/8/8/8/8/PPPPPPPP/";
        for (let i = 0; i <= 7; i++)
            str += num2Piece(board[i]);
...
exports.default = frcGen;
//# sourceMappingURL=startingPosition.js.map