...
class Game {
    static genBoard = () => (0, startingPosition_1.default)();
    _history = [];
    shortNotationMoves = '';
    gameOver = false;
    startingFEN;
                            ...
                            this.newMove({
                                ...
                                move: {
                                    ...
                                    notation: {
                                        ...
                                        long: (0, functions_1.convertToChessNotation)(kingPos) + (0, functions_1.convertToChessNotation)(endingPos)
                                    }
                                }
                            });
                            moveFound = true;
    ...
    checkForOpening() {
        ...
        for (let i = 0; i < moves.length; i++) {
            const opening = openings_json_1.default[moves.slice(0, i).join(' ')];
            if (!opening)
                continue;
